...
public class EulerGraph {
	 ...
	 * @param s			start node
	 * @return			Euler Path. null -> Euler Path (with start node s) doesn't exists.
	 */
	 ...
	 * @param s			start node
	 * @param g			goal node
	 * @return			Euler Path. null -> Euler Path (with start node s, goal node g) doesn't exists.
	 */
	 ...
	 * If the Graph is not Euler Graph, returns null.
	 ...
	 * @param adjList	adjacency list
	 * @return			ret. null -> not Euler graph. !null -> array.
	 */
	 ...
	 * @return			Euler path. null -> Euler path (with start node s) doesn't exist.
	 */
